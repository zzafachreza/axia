...
export default function Home3({ navigation, route }) {
    ...
    const [soal, setSoal] = useState(route.params.soal);
    ...
    const [nilai, setNilai] = useState(route.params.nilai);
                                            ...
                                            if (soal % 2 != 0) {
                                                ...
                                                if (soal == 6 && (nilai + 1) == 6) {
                                                    ...
                                                    navigation.navigate('GoalKanan', {
                                                        next: 'Home4',
                                                        soal: 2,
                                                        nilai: parseFloat(route.params.nilai) + 1
                                                    });
                                                    setSoal(soal + 1)
                                            ...
                                            if (soal % 2 != 0) {
                                                ...
                                                if (soal == 6 && (nilai + 1) == 6) {
                                                    ...
                                                    navigation.navigate('GoalKiri', {
                                                        next: 'Home4',
                                                        soal: 3,
                                                        nilai: parseInt(route.params.nilai) + 1
                                                    });
                                                    setSoal(soal + 1);
                                                }
